...
export const resendUserVerificationTokenPath = new RoutePath('PATCH', '/user/verify')

@InjectableRoute(resendUserVerificationTokenPath)
export class ResendUserVerificationTokenRoute
  implements Route<undefined, UserVerificationTokenResponse> {
  constructor(
